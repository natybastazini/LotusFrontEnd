...
export default function Card({ titulo, imagem, onClick }) {

    return (
        <div>
            <button onClick={onClick}    className="h-72 w-[500px] bg-white rounded-2xl shadow-lg aspect-video hover:scale-105 transition duration-200">
