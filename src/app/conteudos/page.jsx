...
import ContentButton from "@/components/BotaoAdd";
    ...
    <div className="flex h-screen">
      <header className="flex flex-col md:w-[20%] py-10 px-10">
        ...
        <nav className="flex flex-col gap-10 h-[80%]">
          <a
            href="#"
            className="flex flex-row items-center p-2 gap-2 hover:bg-pink-degrade-1 transition duration-200 rounded-xl group"
          >
            <Image
              src={LogoHome}
              alt="home"
              className="fill-current group-hover:text-white size-8"
            ></Image>
      ...
      <main className="w-[80%] bg-white p-10">
        ...
        <div className="bg-gray-1 w-full h-full rounded-[40px] overflow-hidden flex flex-col">
          ...
          <div className="h-[60%] flex flex-col justify-between gap-4 px-10 grow">
            ...
            <div
              className="flex flex-col gap-2 h-full overflow-y-scroll overscroll-x-none p-4"
              style={{
                scrollbarWidth: "none",
              }}
            >
